...
//
// Description		
//		Contains the definition of QuickGameJoinRequest
//
// Revision history
//		Date			Description
...
//
// ===================================================================
#ifndef __QuickGameJoinRequest__
#define __QuickGameJoinRequest__
...
namespace Game {
	...
	/// </remarks>
	class DLLImportExport QuickGameJoinRequest : public BaseRequest
	{
	public:
		...
		/// <summary>
		/// <see cref=" QuickGameJoinRequest(boost::shared_ptr<MatchExpression>, vector<boost::shared_ptr<string>>, boost::shared_ptr<Room>)"/>
		/// </summary>
		QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<string> > > whereToSearch);
		...
		QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<string> > > whereToSearch, boost::shared_ptr<Room> roomToLeave);

		/// <summary>
		/// <see cref=" QuickGameJoinRequest(boost::shared_ptr<MatchExpression>, vector<boost::shared_ptr<string>>, boost::shared_ptr<Room>)"/>
		/// </summary>
		QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<Room> > > whereToSearch);

		/// <summary>
		/// <see cref=" QuickGameJoinRequest(boost::shared_ptr<MatchExpression>, vector<boost::shared_ptr<string>>, boost::shared_ptr<Room>)"/>
		/// </summary>
		QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<Room> > > whereToSearch, boost::shared_ptr<Room> roomToLeave);

		virtual ~QuickGameJoinRequest();
