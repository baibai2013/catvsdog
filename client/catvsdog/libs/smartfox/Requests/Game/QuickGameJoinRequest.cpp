...
//
// Description		
//		Contains the implementation of QuickGameJoinRequest
//
// Revision history
//		Date			Description
...
//
// ===================================================================
#include "QuickGameJoinRequest.h"

namespace Sfs2X {
namespace Requests {
namespace Game {

const long int QuickGameJoinRequest::MAX_ROOMS = 32;
boost::shared_ptr<string> QuickGameJoinRequest::KEY_ROOM_LIST (new string("rl"));
boost::shared_ptr<string> QuickGameJoinRequest::KEY_GROUP_LIST (new string("gl"));
boost::shared_ptr<string> QuickGameJoinRequest::KEY_ROOM_TO_LEAVE (new string("tl"));
boost::shared_ptr<string> QuickGameJoinRequest::KEY_MATCH_EXPRESSION (new string("me"));

// -------------------------------------------------------------------
// Constructor
// -------------------------------------------------------------------		
QuickGameJoinRequest::QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<string> > > whereToSearch)
...
// Constructor
// -------------------------------------------------------------------		
QuickGameJoinRequest::QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<string> > > whereToSearch, boost::shared_ptr<Room> roomToLeave)
	: BaseRequest (RequestType_QuickJoinGame)
{
	this->isSearchListString = false;
	this->isSearchListRoom = false;
...
// Constructor
// -------------------------------------------------------------------		
QuickGameJoinRequest::QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<Room> > > whereToSearch)
	: BaseRequest (RequestType_QuickJoinGame)
{
	this->isSearchListString = false;
	this->isSearchListRoom = false;
...
// Constructor
// -------------------------------------------------------------------		
QuickGameJoinRequest::QuickGameJoinRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<Room> > > whereToSearch, boost::shared_ptr<Room> roomToLeave)
	: BaseRequest (RequestType_QuickJoinGame)
{
	this->isSearchListString = false;
	this->isSearchListRoom = false;
...
// Destructor
// -------------------------------------------------------------------		
QuickGameJoinRequest::~QuickGameJoinRequest()
{
...
// Init
// -------------------------------------------------------------------		
void QuickGameJoinRequest::Init(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<string> > > whereToSearch, boost::shared_ptr<Room> roomToLeave)
{
...
// Init
// -------------------------------------------------------------------		
void QuickGameJoinRequest::Init(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<vector<boost::shared_ptr<Room> > > whereToSearch, boost::shared_ptr<Room> roomToLeave)
{
	this->matchExpression = matchExpression;
...
// Validate
// -------------------------------------------------------------------
void QuickGameJoinRequest::Validate(boost::shared_ptr<SmartFox> sfs)
{
...
// Execute
// -------------------------------------------------------------------
void QuickGameJoinRequest::Execute(boost::shared_ptr<SmartFox> sfs)
{
